...
public:
	...
	{
		OpenGLShaderLibrary::Instance()->Add_Shader_From_File("test_vert.vert", "test_frag.frag", "test_shader");
		...
		screen_cover->Add_Shader_Program(OpenGLShaderLibrary::Get_Shader("test_shader"));
