...
set(src_lib_lis common reservoir mesh_ext common_cpx poisson_cpx geometry optimization parallel solver viewer physics)
...
macro(use_src_libs mode lib_lis)
  ...
  if(${mode} STREQUAL "SELF")
    set(src_lib_path ${prjplex_path}/bin/${proj_name}/lib/simplex)
  ...
  foreach(lib_name ${src_lib_lis})
    if(${lib_name} IN_LIST lib_lis)
        set(target_lib_build_path ${src_lib_path}/${lib_name})
