...
####${current_target}_propagated_exts: propagated ext libs, which will be installed lastly
...
####exe_output_path=simplex/bin/${proj_name}
...
####CPM_SOURCE_CACHE: simplex/lib/cpm
###############################################################################
...
macro(init_target _target_name)
  ...
  set(${current_target}_propagated_exts "")
...
macro(fast_debug_info)
  ...
  message(STATUS "Propagated ext libs of ${current_target}: ${${current_target}_propagated_exts}")
  message(STATUS "Included dirs of ${current_target}: ${${current_target}_incs}")
  message(STATUS "Src files of ${current_target}: ${${current_target}_srcs}")
  message(STATUS "Lib files of ${current_target}: ${${current_target}_libs}")
  message(STATUS "Dep targets of ${current_target}: ${${current_target}_deps}")
  message(STATUS "Dll files of ${current_target}: ${${current_target}_dlls}")
