...
macro(set_cuda_options)
  if(WIN32)
    set(openmp_opt "/openmp")
  else()
    set(openmp_opt "-fopenmp")
  endif()
  ...
  target_compile_options(${current_target} PRIVATE $<$<COMPILE_LANGUAGE:CUDA>:
            --extended-lambda -Xcompiler ${openmp_opt}
...
macro(target_setup_all_resources target_type)
  #This goes first, because it installs to the other ${current_target} variables
  install_propagated_libs("${${current_target}_propagated_exts}")
...
macro(pass_resources_to_global)
  ...
  set(${current_target}_propagated_exts_global ${${current_target}_propagated_exts} CACHE STRING INTERNAL FORCE)
...
macro(merge_resources_from_target dep_name)
  ...
  list(APPEND ${current_target}_propagated_exts ${${dep_name}_propagated_exts_global})
  ...
  list(REMOVE_DUPLICATES ${current_target}_propagated_exts)
