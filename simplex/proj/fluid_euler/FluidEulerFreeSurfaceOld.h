...
template<int d> class FluidEulerFreeSurfaceOld : public FluidEulerOld<d>
...
public:
	...
	bool verbose=false;
public:
	FluidEulerFreeSurfaceOld(const SolverType &_solver_mode=SolverType::MULTIGRID_AUTO): projection(mac_grid, velocity, levelset, bc) {}
