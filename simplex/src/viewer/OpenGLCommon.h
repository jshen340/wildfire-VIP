...
glm::mat3 inline ToGlm(const Matrix3& m){return glm::highp_mat3x3(glm::make_mat3<real>(m.data()));}/// TOFIX
glm::mat4 inline ToGlm(const Matrix4& m){return glm::highp_mat4x4(glm::make_mat4<real>(m.data()));}/// TOFIX
